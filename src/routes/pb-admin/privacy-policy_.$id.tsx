...
export const Route = createFileRoute("/pb-admin/privacy-policy_/$id")({
...
function EditPrivacyPolicyPage() {
  ...
  const [content, setContent] = useState(policyItem.content);
  ...
  const handleSave = (e: React.FormEvent) => {
    e.preventDefault();
    toast.success(`Privacy Policy for ${selectedRole} updated successfully!`);
    navigate({ to: "/pb-admin/privacy-policy" });
  };

  return (
    <AppShell
      title="Edit Privacy Policy"
      subtitle={`Edit system policy details for ${selectedRole}.`}
    >
      <div className="p-4 sm:p-6 md:p-8 max-w-5xl space-y-6">
        ...
        <form onSubmit={handleSave} className="space-y-6">
          ...
          <div className="flex items-center justify-end gap-3 pt-2">
            <button
              type="button"
              onClick={() => navigate({ to: "/pb-admin/privacy-policy" })}
