...
import { type PolicyRole } from "@/lib/privacy-policy-data";

export const Route = createFileRoute("/pb-admin/privacy-policy_/new")({
...
function CreatePrivacyPolicyPage() {
  ...
  const handleSave = (e: React.FormEvent) => {
    e.preventDefault();
    toast.success(`Privacy Policy for ${selectedRole} created successfully!`);
  ...
  return (
    <AppShell
      ...
      subtitle="Define and publish a new privacy policy version for specified platform roles."
    >
