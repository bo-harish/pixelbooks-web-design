...
export const Route = createFileRoute("/library-user/login")({
  head: () => ({
    meta: [
      { title: "Library Login — PixelBooks" },
      {
        name: "description",
        content: "Institutional portal login and password recovery.",
      },
    ],
  }),
          ...
          {viewMode === "login" && (
            <div className="space-y-5 animate-in fade-in duration-200">
              ...
              <div className="space-y-4 pt-1">
                {/* PRIMARY METHOD: LOGIN ID & PASSWORD */}
                ...
                {loginMethod === "otp" && (
                  <div className="space-y-3.5 animate-in fade-in duration-150">
                    ...
                    >
                      <Lock size={14} />
                      Sign in with Login ID & Password
                    </button>
                  </div>
                )}
              </div>
              ...
              {!forgotSubmitted ? (
                <div className="space-y-6 text-center py-2">
                  ...
                  <div className="space-y-1.5 text-left mt-6">
                    <label className="text-xs font-bold text-slate-700 dark:text-slate-200 block">
                      Login ID<span className="text-rose-500 ml-0.5">*</span>
                    </label>
                    <div className="relative">
                      <input
                        type="text"
