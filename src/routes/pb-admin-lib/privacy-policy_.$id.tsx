...
export const Route = createFileRoute("/pb-admin-lib/privacy-policy_/$id")({
...
function EditPrivacyPolicyPage() {
  ...
  const handleSave = (e: React.FormEvent) => {
    ...
    navigate({ to: "/pb-admin-lib/privacy-policy" });
  };
      ...
      <div className="p-4 sm:p-6 md:p-8 max-w-5xl space-y-6">
        ...
        <form onSubmit={handleSave} className="space-y-6">
          ...
          <div className="flex items-center justify-end gap-3 pt-2">
            <button
              type="button"
              onClick={() => navigate({ to: "/pb-admin-lib/privacy-policy" })}
